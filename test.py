...
def record():
    ...
    Bình thường hóa (Normalize) âm thanh, cắt bớt khoảng trống ở đầu và cuối, các phần đệm có 0,5 giây của âm trống đảm bảo VLC có thể phát mà không cần cắt nhỏ."""
    p = pyaudio.PyAudio()
    ...
    while 1:
        # độ bền nhỏ, âm ngắn đánh được đánh dấu
...
if __name__ == "__main__":
    ...
    parser.add_argument("-e", "--emotions", help="""Cam xuc de nhan dien duoc cach nhau bang dau phay ',', cam xuc de nhan dien la "neutral", "calm", "happy" "sad", "angry", "fear", "disgust", "ps" (ngac nhien) and "boredom", mac dinh la "sad,neutral,happy"
""", default="sad,neutral,happy")
    parser.add_argument("-m", "--model", help="""Mo hinh duoc dung, 8 mo hinh duoc su dung la: {}, mac dinh la "BaggingClassifier" """.format(estimators_str),default="BaggingClassifier")
    ...
    detector.train()
    print("Độ chính xác khi kiểm tra: {:.3f}%".format(detector.test_score()*100))
